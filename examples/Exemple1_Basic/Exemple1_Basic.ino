...
const int resolution = 8; //Résolution 8 bits; duty cycle de 0 à 255
int pinLED2 = 2;
void setup() {
...
void ajusteLED2() {
  ...
  if(valeur == 0) { ledcWrite(ledChannel, 0); }       //Cas pour la valeur courante "0" correspondant à "Eteint"
  else if(valeur == 1) { ledcWrite(ledChannel, 20); } //Cas pour la valeur courante "1" correspondant à "Bas"
  else if(valeur == 2) { ledcWrite(ledChannel, 80); } //Cas pour la valeur courante "2" correspondant à "Moyen"
  else if(valeur == 3) { ledcWrite(ledChannel, 255); }//Cas pour la valeur courante "3" correspondant à "Fort"
}
void callBackItemX() {
